...
//=========================================================================
var PANEL_TYPE = "org.idch.examples.QuickNote";
 ...
 */
function QuickNote(m_panel, m_cfg) {
 ...
 * @public
 */
IDCH.examples.Panels.QUICK_NOTE = PANEL_TYPE;

// finally, register this panel constructor with the workspace
IDCH.critspace.PanelRegistry.register(PANEL_TYPE, QuickNote);
